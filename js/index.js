...
window.particlesJS.load = function (tag_id, path_config_json, callback) {
  ...
  function updateTime() {
      ...
      // Hiển thị thời gian và buổi trong ngày trên cùng dòng
      document.getElementById('momk').innerHTML = hour + ":" + minute + ":" + second + "  " + period;
    }

    // Cập nhật thời gian mỗi giây
    setInterval(updateTime, 1000);

    // Gọi hàm updateTime để hiển thị thời gian ban đầu
    updateTime();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/ngloc.3110');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Discord');
    telegramDiv.addEventListener('click', function () {
        window.open('https://discord.gg/xgmCq43d');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/dithia25/');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@locng3110');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/@Loc_Nguyen3110/featured');
    });
});
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Lộc NGuyễn >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
welcomeText.textContent = "Designed By Nguyễn Đại Lộc =))";
